...
namespace CarBookUdemy.WebApi.Controllers
{
    ...
    public class BrandsController : ControllerBase
    {
        ...
        public BrandsController(CreateBrandCommandHandler creatBrandCommandHandler, GetBrandByIdQueryHandler getBrandByIdQueryHandler, GetBrandQueryHandler getBrandQueryHandler, UpdateBrandCommandHandler updateBrandCommandHandler, RemoveBrandCommandHandler removeBrandCommandHandler)
        {
