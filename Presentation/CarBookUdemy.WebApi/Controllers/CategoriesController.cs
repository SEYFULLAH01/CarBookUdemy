...
using CarBookUdemy.Application.Features.CQRS.Handlers.CategoryHandlers;
...
namespace CarBookUdemy.WebApi.Controllers
{
    ...
    public class CategoriesController : ControllerBase
    {
        ...
        public CategoriesController(CreateCategoryCommandHandler creatCategoryCommandHandler, GetCategoryByIdQueryHandler getCategoryByIdQueryHandler, GetCategoryQueryHandler getCategoryQueryHandler, UpdateCategoryCommandHandler updateCategoryCommandHandler, RemoveCategoryCommandHandler removeCategoryCommandHandler)
        {
            _creatCategoryCommandHandler = creatCategoryCommandHandler;
